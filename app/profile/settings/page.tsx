    ...
    <div style={{ minHeight: '100vh', background: '#f5f0eb', paddingBottom: 40 }}>
      ...
      <div style={{ padding: '20px 16px', borderBottom: '1px solid #f0f0f0' }}>
        ...
        {[
          ...
          <div key={key} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, padding: '12px', background: 'white', borderRadius: 12, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            <div>
      ...
      <div style={{ padding: '20px 16px', borderBottom: '1px solid #f0f0f0' }}>
        ...
        <button style={{ width: '100%', padding: '14px 16px', background: 'white', border: 'none', borderRadius: 12, textAlign: 'left', fontSize: 15, fontWeight: 600, color: '#333', cursor: 'pointer', boxShadow: '0 1px 3px rgba(0,0,0,0.04)', marginBottom: 10 }}>
      ...
      <div style={{ padding: '20px 16px' }}>
        ...
        <button style={{ width: '100%', padding: '14px 16px', background: 'white', border: 'none', borderRadius: 12, textAlign: 'left', fontSize: 15, fontWeight: 600, color: '#333', cursor: 'pointer', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
