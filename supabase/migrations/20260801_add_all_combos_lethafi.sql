-- Add all 8 Combos items to Lethafi cafeteria with correct veg/non-veg classification
...
CROSS JOIN (
  VALUES
    ...
    ('Fries 1/2 + Crinkle Fries 1/2 + Finger Chicken + Watermelon(jumbo)', 'Mix of fries, chicken, and watermelon juice', 189, false),
