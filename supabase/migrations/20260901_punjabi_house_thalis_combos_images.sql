...
-- Mania, Veg Thali). From the public 'Punjabi house' storage bucket —
-- each subfolder's files listed directly via the Storage API and matched
-- 1:1 against the category's dishes.
