...
-- Cream, Juice, Mojitos, Pasta, Shakes, Signature Shake). These were wiped
-- back to null by an earlier revert -- reapplied from the public
-- 'Punjabi house' storage bucket, files listed directly via the Storage
-- API and matched 1:1 against the category's dishes. Same mapping as
-- 20260901_punjabi_house_shake_pasta_juice_images.sql.
