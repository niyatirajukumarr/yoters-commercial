...
--
-- Fixed 2026-08-27: originally filtered category = 'Breads', but these items
-- actually live under category = 'Kulche' — every WHERE clause below matched
-- zero rows as a result, so running this migration silently did nothing.
