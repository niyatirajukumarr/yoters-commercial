...
-- Paneer Starters, Veg Chinese Starters, Veg Tandoor Starters). These
-- were wiped back to null by an earlier revert -- reapplied from the
-- public 'Punjabi house' storage bucket, same mapping as the original
-- 20260831 migration. "Afghani Malai Paneer Tikka" (Veg Tandoor
-- Starters) still has no file in the folder and keeps its placeholder
-- image.
