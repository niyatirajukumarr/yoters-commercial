...
import { trackHref, useRouteId } from '@/lib/routes'
...
const ITEM_IMAGES: { [key: string]: string } = {
  ...
  // THE PUNJABI HOUSE - STARTERS TANDOOR
  'Paneer Tikka':                 'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Peri Peri Paneer Tikka':       'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Afghani Malai Paneer Tikka':   'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Achari Paneer Tikka':          'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Lemon Paneer Tikka':           'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Lemon Chaap Tikka':            'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Peri Peri Chaap Tikka':        'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Delhi Soya Chaap Tikka':       'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Afghani Malai Soya Chaap':     'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Tandoori Mushroom':            'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Hara Bhara Kebab':             'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Dahi Kebab':                   'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Veg Tandoori Platter':         'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - STARTERS PANEER
  'Paneer Chilly':                'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Paneer Manchurian':            'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Dragon Paneer':                'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Paneer Majestic':              'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Paneer Pepper Dry':            'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Paneer 65':                    'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',
  'Lemon Paneer':                 'https://images.unsplash.com/photo-1626082927389-6cd097cda1ec?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - STARTERS VEG CHINESE
  'Honey Chilly Potato':          'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Crispy Corn':                  'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Veg Manchurian':               'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Crispy Chilli Potato':         'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Gobi Manchurian / Chilly':     'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Gobi Pepper Dry / 65':         'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Mushroom Manchurian / Chilly': 'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Mushroom Pepper Dry':          'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Babycorn Manchurian / Chilly': 'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Babycorn Pepper Dry':          'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - SOUPS & APPETIZERS
  'Masala Papad':                 'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Roasted / Fry Papad':          'https://images.unsplash.com/photo-1599603810694-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Dal Bhadi Raita':              'https://images.unsplash.com/photo-1540189549336-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Veg / Boondi Raita':           'https://images.unsplash.com/photo-1540189549336-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Green Salad':                  'https://images.unsplash.com/photo-1540189549336-e6e99eaf27fa?w=200&h=200&fit=crop',
  'Veg Manchow Soup':             'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=200&h=200&fit=crop',
  'Veg Hot & Sour Soup':          'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=200&h=200&fit=crop',
  'Tomato Soup':                  'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=200&h=200&fit=crop',
  'Lemon Coriander Soup':         'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - CHICKEN STARTERS TANDOOR
  'Chicken Tikka':                'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Boneless Chicken Tikka':       'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Afghani Malai Chicken Tikka':  'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Garlic Chicken Tikka':         'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Lemon Chicken Tikka':          'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Sheek Kebab':          'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Reshmi Kebab':         'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Tangri Kebab':         'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Patiala Tangri Kebab':         'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Afghani Tangri Kebab':         'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Tandoori Platter':     'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - CHICKEN STARTERS CHINESE
  'Drums of Heaven':              'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Lollipop (Chilly/Manchurian)': 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Kali Mirch Andhra Special': 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Dragon Chicken':               'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Majestic':             'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chilly Chicken':               'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Manchurian':           'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Lemon Chicken':                'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken 65':                   'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Pepper Dry':           'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Garlic Chicken':               'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Fry Kebab':            'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - EGG DELIGHTS STARTERS
  'Egg Chilly':                   'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Egg Manchurian':               'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Egg Pepper Dry':               'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Egg 65':                       'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Egg Bhurji':                   'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Masala Omelette':              'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Plain Omelette':               'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Masala Boiled Eggs':           'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Boiled Eggs':                  'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - CHICKEN SOUPS
  'Chicken Manchow Soup':         'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=200&h=200&fit=crop',
  'Chicken Hot & Sour Soup':      'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=200&h=200&fit=crop',
  'Chicken Clear Soup':           'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=200&h=200&fit=crop',
  'Lemon Coriander Chicken Soup': 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - MAINS PANEER
  'Paneer Tikka Masala':          'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Paneer Takatak':               'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Rara Paneer':                  'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Paneer Tawa':                  'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Amritsari Paneer Masala':      'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Kadhai Paneer':                'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Shahi Paneer':                 'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Punjabi Paneer':               'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Paneer Kolhapuri':             'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Palak Paneer':                 'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Paneer Do Pyaza':              'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Matar Paneer':                 'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Paneer Pasanda':               'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Kaju Paneer':                  'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Paneer Bhurji':                'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - MAINS KOFTA & DAL
  'Malai Paneer Kofta':           'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Veg Kofta':                    'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Paneer Kofta':                 'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Dal Makhani':                  'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Special Dhaba Style Dal':      'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Ghee Dal Tadka':               'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Dal Fry':                      'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - MAINS NAWABI
  'Mushroom Tikka Masala':        'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Mushroom Masala':              'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Matar Mushroom':               'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Kadhai Mushroom':              'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Chaap Tikka Masala':           'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Tawa Chaap':                   'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Chaap Butter Masala':          'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Punjabi Chaap Masala':         'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Shahi Chaap Masala':           'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Kali Masala':                  'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Kaju Kolhapuri':               'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - MAINS PUNJABI
  'Veg Jalfrezi':                 'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Rajma Masala':                 'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Punjabi Kadhi Pakoda':         'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Chana Masala':                 'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Chana Paneer Masala':          'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Aloo Gobi Matar':              'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Aloo Jeera - Dry':             'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Bhindi Fry - Dry':             'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Bhindi Masala':                'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - VEG DELIGHTS
  'Mix Veg':                      'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Veg Kadhai':                   'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Veg Kolhapuri':                'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Veg Nizami Handi':             'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Tawa Veg':                     'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',
  'Green Peas Masala':            'https://images.unsplash.com/photo-1601050915917-f3f88e0055be?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - CHICKEN MAINS
  'Signature Delhi Butter Chicken': 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Tandoori Chicken Masala':      'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Tikka Masala':         'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Punjabi Chicken Masala':       'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Pind\'s Fav- Rara Chicken':    'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Special Chicken Takatak':      'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Dhaba Style Kadhai Chicken':   'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Kolhapuri':            'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Mughlai Chicken Labaddar':     'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Patiala Dalak Chicken':        'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Afghani Malai Chicken':        'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Nawabi Chicken Korma':         'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Dhaba Chicken Masala':         'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Chicken Kali Mirch':           'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Homestyle Chicken Curry':      'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - EGG MAINS
  'Egg Punjabi Masala':           'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Egg Kadhai':                   'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Egg Kolhapuri':                'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Dhaba Egg Masala':             'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'Egg Curry':                    'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - MUTTON MAINS
  'Mutton Rogan Josh':            'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Rara Mutton':                  'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Mutton Kadhai':                'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',
  'Mutton Masala':                'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - BREADS
  'Plain Phulka':                 'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Butter Phulka':                'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Desi Ghee Phulka':             'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Plain Tandoori Roti':          'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Butter Tandoori Roti':         'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Bread Basket':                 'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Cheese Garlic Naan':           'https://images.unsplash.com/photo-1585521537196-7b0de6c7fbe8?w=200&h=200&fit=crop',
  'Cheese Naan':                  'https://images.unsplash.com/photo-1585521537196-7b0de6c7fbe8?w=200&h=200&fit=crop',
  'Garlic Naan':                  'https://images.unsplash.com/photo-1585521537196-7b0de6c7fbe8?w=200&h=200&fit=crop',
  'Butter Naan':                  'https://images.unsplash.com/photo-1585521537196-7b0de6c7fbe8?w=200&h=200&fit=crop',
  'Plain Naan':                   'https://images.unsplash.com/photo-1585521537196-7b0de6c7fbe8?w=200&h=200&fit=crop',
  'Aloo Pyaaz Chur Naan':         'https://images.unsplash.com/photo-1585521537196-7b0de6c7fbe8?w=200&h=200&fit=crop',
  'Paneer Chur Chur Naan':        'https://images.unsplash.com/photo-1585521537196-7b0de6c7fbe8?w=200&h=200&fit=crop',
  'Garlic Laccha Paratha':        'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'SPL Laccha Paratha':           'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Kerela Paratha':               'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Tawa Paratha':                 'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Ajwain Paratha':               'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Cheese Kulcha':                'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Butter Kulcha':                'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Plain Kulcha':                 'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Paneer Kulcha':                'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Aloo Pyaaz Kulcha':            'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Amritsari Kulcha':             'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Rumali Roti':                  'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Aloo Paratha':                 'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Pyaaz Paratha':                'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Aloo Pyaaz Paratha':           'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Paneer Paratha':               'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',
  'Gobi Paratha':                 'https://images.unsplash.com/photo-1596379957409-a3a5c67df32f?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - RICE & NOODLES
  'Veg Chowmein':                 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Veg Noodles':                  'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Manchurian Noodles':           'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Gobi Noodles':                 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Pepper Noodles':               'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Mushroom Noodles':             'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Chilli Garlic Noodles':        'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Chicken Chowmein':             'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Chicken Noodles':              'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Schezwan Chicken Noodles':     'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Chilli Garlic Chicken Noodles': 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Egg Noodles':                  'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Egg Schezwan Noodles':         'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Egg Chilli Garlic Noodles':    'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop',
  'Veg Fried Rice':               'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Manchurian Fried Rice':        'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Gobi Fried Rice':              'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Paneer Fried Rice':            'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Mushroom Fried Rice':          'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Chilli Garlic Rice':           'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Chicken Fried Rice':           'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Schezwan Chicken Fried Rice':  'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Chilli Garlic Chicken Rice':   'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Egg Fried Rice':               'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Egg Schezwan Fried Rice':      'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Egg Chilli Garlic Fried Rice': 'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Steam Rice':                   'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Jeera Rice':                   'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Ghee Rice':                    'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Dal Khichdi':                  'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Palak Khichdi':                'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Masala Rice':                  'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Paneer Pulav':                 'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Veg Pulav':                    'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Green Peas Pulav':             'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',
  'Curd Rice':                    'https://images.unsplash.com/photo-1609501676725-7186f017a4b2?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - BIRYANI
  'Hyderabadi Chicken Dum Biryani': 'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Kolkata Chicken Dum Biryani':  'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Butter Chicken Boneless Biryani': 'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Chicken Tikka Biryani':        'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Mughlai Chicken Biryani':      'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Grill Chicken Biryani':        'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Alfham Chicken + Biryani Rice': 'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Tandoori Chicken Biryani':     'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Khuska - Kebab (4pcs)':        'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Biryani Rice (Khuska)':        'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Mutton Dum Biryani':           'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Kolkata Mutton Biryani':       'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Egg Biryani':                  'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Paneer Tikka Biryani':         'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Paneer Biryani':               'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Mushroom Biryani':             'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Veg Dum Biryani':              'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'TPH Special Veg Biryani':      'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',
  'Chaap Tikka Biryani':          'https://images.unsplash.com/photo-1589301760014-d929314c3fe6?w=200&h=200&fit=crop',

  // THE PUNJABI HOUSE - COMBOS & THALIS
  'SPL Veg Punjabi Thali':        'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Premium Veg Thali':            'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Cholay/Rajma Thali':           'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Gobi Manchurian Thali':        'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'SPL Non-Veg Punjabi Thali':    'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Butter Chicken Thali':         'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Chicken Masala Thali':         'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Grill/Alfham/Tandoori Chicken Meal': 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Amritsari Aloo Kulcha Combo':  'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Paneer Chur-Chur Naan Combo':  'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Aloo Pyaaz Chur-Chur Naan':    'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Poori Sabi Combo':             'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Delhi Cholay Bhature':         'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Chicken Biryani Family Pack (Serves 3-4)': 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Chicken Biryani Couple Pack (Serves 2)': 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Chicken Tikka Masala Combo':   'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Butter Chicken Combo':         'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Chilly Chicken Combo':         'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Veg Curry Combo':              'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Kadhai Paneer Combo':          'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Gobi Manchurian Combo':        'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Butter Chicken Rice Bowl':     'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Chicken Curry Rice Bowl':      'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Egg Curry Rice Bowl':          'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Kadhai Paneer Rice Bowl':      'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Cholay Rice Bowl':             'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Kadi Pakoda Rice Bowl':        'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Dal Makhani Rice Bowl':        'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Dal Tadka Rice Bowl':          'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Rajma Chawal Bowl':            'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  'Gobi / Veg Manchurian Bowl':   'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&h=200&fit=crop',
  ...
  // THE PUNJABI HOUSE - PASTA
  'White Sauce Pasta':            'https://images.unsplash.com/photo-1621996346565-431f63602f41?w=200&h=200&fit=crop',
  'Red Sauce Pasta':              'https://images.unsplash.com/photo-1621996346565-431f63602f41?w=200&h=200&fit=crop',
  'Pink Sauce Pasta':             'https://images.unsplash.com/photo-1621996346565-431f63602f41?w=200&h=200&fit=crop',
  'Creamy Mushroom Pasta':        'https://images.unsplash.com/photo-1621996346565-431f63602f41?w=200&h=200&fit=crop',
  'Chicken White Sauce Pasta':    'https://images.unsplash.com/photo-1621996346565-431f63602f41?w=200&h=200&fit=crop',
  ...
  'Choco Lava Cake':              'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=200&h=200&fit=crop',
  'Walnut Brownie':               'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=200&h=200&fit=crop',
  'Matka Rabdi':                  'https://images.unsplash.com/photo-1551632440-e5e89f63c076?w=200&h=200&fit=crop',
  'Rasmalai':                     'https://images.unsplash.com/photo-1551632440-e5e89f63c076?w=200&h=200&fit=crop',
}
...
export default function CafeteriaOrderScreen() {
  const router = useRouter()
  const searchParams = useSearchParams()
  const slugOrId = useRouteId('cafeteriaId', 'cafe')
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const res = await apiFetch(`/api/menu-popularity?cafeteriaId=${cafeteriaId}`)
  ...
  const fetchTokenData = async (attempt = 0) => {
    ...
    if (data?.token_number != null) {
      ...
      setTimeout(() => router.push(trackHref(orderId)), 2000)
      return
    }
    ...
    <div style={{
                ...
                {cafeOrders.map(order => {
                  ...
                  return (
                    <motion.div
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={() => { if (!isPending) window.location.href = trackHref(order.id) }}
      ...
      {showTicket && tokenData && (
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} style={{ padding: 'var(--mobile-spacing)', textAlign: 'center', paddingTop: 20 }}>
          ...
          <motion.button
            {...hoverScale}
            onClick={() => router.push(trackHref(tokenData.id))}
