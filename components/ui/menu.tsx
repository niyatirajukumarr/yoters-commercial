...
interface UserProfile {
  name: string;
  email: string;
  // No avatar/photo field exists in this app's user data (see
  // lib/hooks/useUserInfo.ts) — optional, with an initials-circle fallback
  // below matching the avatar pattern already used elsewhere in the app
  // (components/landing/Navbar.tsx, app/browse/page.tsx), rather than
  // fabricating a stock photo or calling a third-party avatar service.
  avatarUrl?: string;
}
